...
$this->title = '员工列表';
AppAsset::addScript($this, 'manage/js/staff/staff.js');

?>
<link rel="stylesheet" href="/manage/css/staff/staff.css"/>
        ...
        <div class="panel-body">
            ...
            <div class="col-md-12 df pt15">
                ...
                <div class="col-md-10 right-div">
                    <h4 class="text-center">员工列表（<span id="staffItemsNum"></span>）</h4>
                    <div class="panel-body">
                        <div class="table-div">
                            <table class="table table-bordered table-striped" id="example-2" role="grid">
                                ...
                                <tr>
                                    ...
                                    <td>东莞火炼树团队</td>
                                    <td>副队长</td>
                                    <td>222405199102121811</td>
                                    <td>广州市海珠区赤岗西路288号杨协成电子创意园F座</td>
                                    <td>2015-12-11</td>
                                    <td>已绑定</td>
                                    <td>
                                        <a href="#" class="btn btn-info">编辑</a>
                                        <a href="#" class="btn btn-info btn-move">设定团队</a>
                                        <a href="#" class="btn btn-danger btn-del">离职</a>
                                        <a href="#" class="btn btn-info btn-del">绑定身份</a>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
